...
public class CrocodileAbility : NetworkBehaviour, IAnimalAbility, IPlayerAbility
{
    ...
    {
        enabled = (type == AnimalType.Crocodile);
        Debug.Log("[CrocodileAbility] ServerActivate 호출" + enabled);
    }
    [Server]
