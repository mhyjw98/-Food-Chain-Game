...
public class WoodItemB : MonoBehaviour, IEndDragHandler
{
    ...
    private WoodBag _bag;
    private WoodB _mission;
    ...
    public void Init(WoodB mission, Vector2 spawnPos)
    {
        _mission = mission;
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        if (itemType != BagItemType.Wood) return;
